  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          'focus-visible:ring-2 focus-visible:ring-primary/40 flex flex-1 items-center justify-between gap-4 rounded-xl py-4 sm:py-5 text-left text-base sm:text-lg font-semibold transition-all outline-none hover:text-primary disabled:pointer-events-none disabled:opacity-50 [&[data-state=open]>svg]:rotate-180 cursor-pointer',
          className,
        )}
        {...props}
      >
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down overflow-hidden text-base leading-relaxed text-muted-foreground"
      {...props}
    >
